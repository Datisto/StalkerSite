...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black-900 via-gray-800 to-black text-gray-100">
      <div
...
Вона змушує тебе жити у Зоні, а не пробігати її, як черговий квест.
              ...
              <div className="bg-gray-800 bg-opacity-60 p-6 rounded-lg border border-gray-700 hover:border-red-500 transition">
                <Kanban className="w-12 h-12 text-red-500 mb-4" />
                <h4 className="text-xl font-semibold mb-3">Свій власний ЛОР, що формується гравцями</h4>
                <p className="text-gray-400">
                  Лор сервера розвивається з відкриття у 2023 році<br /> та безпосередньо базується на діях гравців.<br /><br />
У внутрішньому світі проєкту Сама Зона існує з 2006 року,<br /> перші сталкери почали проникнули через периметр у 2010,<br /> закладаючи основу для розвитку подій, угруповань,<br /> конфліктів і загальної історії серверу.<br />

Тут саме гравці формують Зону:<br />
- кожен вибір,<br /> - кожен дія,<br /> - кожна угода чи конфлікт<br /><br /> Усе має наслідки та впливає на те,<br /> яким буде сюжет і атмосфера вашого світу.
                </p>
              </div>
