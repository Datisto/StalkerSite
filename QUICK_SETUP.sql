-- ==========================================
-- STALKER RP - ШВИДКЕ НАЛАШТУВАННЯ MySQL
-- ==========================================

-- 1. Створити базу даних
CREATE DATABASE IF NOT EXISTS stalker_rp CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE stalker_rp;

-- 2. Таблиці (з server/database/schema.sql)
...
-- ==========================================
-- 3. СТВОРИТИ АДМІНА (пароль: admin123)
-- ==========================================
...
VALUES (
  UUID(),
  'admin',
  '$2b$10$YourHashedPasswordHere',  -- Потрібно згенерувати bcrypt hash
  'super_admin',
  TRUE
);

-- Щоб згенерувати hash паролю, виконати в Node.js:
-- const bcrypt = require('bcrypt');
-- console.log(bcrypt.hashSync('admin123', 10));

-- ==========================================
-- 4. SAMPLE DATA (опціонально)
-- ==========================================

-- Додати категорії правил
INSERT INTO rules_categories (id, name, order_index) VALUES
(UUID(), 'Загальні правила', 1),
(UUID(), 'Правила RP', 2),
(UUID(), 'Правила бою', 3);

-- Додати FAQ категорії
INSERT INTO faq_categories (id, name, order_index) VALUES
(UUID(), 'Початок гри', 1),
(UUID(), 'Персонажі', 2),
(UUID(), 'Технічні питання', 3);

SELECT 'База даних успішно створена!' as Status;
