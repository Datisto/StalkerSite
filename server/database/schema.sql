...
CREATE TABLE IF NOT EXISTS characters (
  ...
  military_experience TEXT DEFAULT NULL,
  military_rank VARCHAR(255) DEFAULT NULL,
  military_join_reason TEXT DEFAULT NULL,
  backstory TEXT DEFAULT NULL,
  zone_motivation TEXT DEFAULT NULL,
  character_goals TEXT DEFAULT NULL,
  discord_id VARCHAR(255) DEFAULT NULL,
